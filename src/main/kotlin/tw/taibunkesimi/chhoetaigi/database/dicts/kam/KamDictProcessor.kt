...
//            println("entry: ${srcEntry.id}")
            ...
            outEntry.pojBunimUnicode = tw.taibunkesimi.lib.lomajichoanoann.TaigiLomajiKuikuChoanoann.onlyPojInputToPojUnicode(srcEntry.pojBunim).trim()
            ...
            outEntry.kipBunimInput = tw.taibunkesimi.lib.lomajichoanoann.TaigiLomajiKuikuChoanoann.onlyPojInputToKipInput(srcEntry.pojBunim).trim()
            outEntry.kipBunimUnicode = tw.taibunkesimi.lib.lomajichoanoann.TaigiLomajiKuikuChoanoann.onlyKipInputToKipUnicode(outEntry.kipBunimInput).trim()

            outEntry.pojKaisoeh = tw.taibunkesimi.lib.lomajichoanoann.TaigiLomajiKuikuChoanoann.hybridPojInputToPojUnicode(srcEntry.pojKaisoeh).trim()
            outEntry.kipKaisoeh = tw.taibunkesimi.lib.lomajichoanoann.TaigiLomajiKuikuChoanoann.hybridKipInputToKipUnicode(srcEntry.pojKaisoeh).trim()

            outEntry.hanloTaibunKaisoehPoj = tw.taibunkesimi.lib.lomajichoanoann.TaigiLomajiKuikuChoanoann.hybridPojInputToPojUnicode(srcEntry.hanloTaibunKaisoehPoj).trim()
