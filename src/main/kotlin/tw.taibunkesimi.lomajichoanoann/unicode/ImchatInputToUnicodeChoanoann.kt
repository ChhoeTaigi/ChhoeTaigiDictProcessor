...
import tw.taibunkesimi.lomajichoanoann.unicode.utils.PojSianntiauPosition
import tw.taibunkesimi.lomajichoanoann.unicode.utils.PojUnicodeNotFoundException
import tw.taibunkesimi.lomajichoanoann.extensions.isNumeric
import tw.taibunkesimi.lomajichoanoann.extensions.isUpper
import tw.taibunkesimi.lomajichoanoann.extensions.replaceLast
...
//            println("$pojBoSianntiau$soojiSianntiauString -> $str1$str2$str3")
    ...
    private fun pojInputToUnicodeFixJibo(pojInputString: String): String {
        ...
        if (!pojInputString.contains("nng")) {
            fixedString = pojInputString.replace("nn", "ⁿ")
        }
