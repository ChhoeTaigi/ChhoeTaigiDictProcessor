package tw.taibunkesimi.lib.lomajichoanoann.example
...
//    val result = TaigiLomajiKuikuChoanoann.hybridKipUnicodeToKipInput("1.【數】數字。2.【形】極、最、第一的。例：一流　it-liû。3.【形】相同的。例：\uE701兩个生做一模一樣。In nn̄g ê senn-tsò it-bôo-it-iūnn. (他們兩個長得一模一樣。)　4.【副】整個地、全部地。例：一生　it-sing、一向　it hiòng。")
//    println("$result")
//
//    val result2 = TaigiLomajiKuikuChoanoann.hybridKipUnicodeToPojUnicode("1.【數】數字。2.【形】極、最、第一的。例：一流　it-liû。3.【形】相同的。例：\uE701兩个生做一模一樣。In nn̄g ê senn-tsò it-bôo-it-iūnn. (他們兩個長得一模一樣。)　4.【副】整個地、全部地。例：一生　it-sing、一向　it hiòng。")
//    println("$result2")
//
//    val result3 = PojInputFix.fixKuikuOnlyPojWithDelimiter(
//            "::I ho7+ la5ng ah-to2-tha5u a, bo5 hoat-to7+ thang ho2an-kho3ng a."
//            .replace("::", "")  // remove "::" symbol for subcatogory
//            .replace("*", "nn")  // fix POJ
//            .replace("+", "o")  // fix POJ
//            , EnumSet.of(PojInputFixType.ALL))
//    println("$result3")

//
//    val r = tw.taibunkesimi.lib.lomajichoanoann.TaigiLomajiKuikuChoanoann.hybridPojInputToPojUnicode("(2)做人m7-thang siunn～～＝做人m7-thang siunn過傲慢。")
//    println("$r")
}
