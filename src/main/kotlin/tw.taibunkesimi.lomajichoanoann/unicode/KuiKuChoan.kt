...
import tw.taibunkesimi.lomajichoanoann.chhiatkoeh.HybridType
import tw.taibunkesimi.lomajichoanoann.chhiatkoeh.koeh.LomajiKoeh
import tw.taibunkesimi.lomajichoanoann.hethong.ImchatInputHethongChoanoann
import tw.taibunkesimi.lomajichoanoann.unicode.choanoannsoantek.ChoanoannSoantek
    ...
    fun choanHybridInputWithRegex(str: String, choanoannSoantek: ChoanoannSoantek): String {
        ...
        when (choanoannSoantek) {
            ...
            ChoanoannSoantek.POJ_INPUT_TO_KIP_INPUT -> {
                koehArrayList = ChhiatKoeh.chhiatHybridInputWithRegex(str, HybridType.HYBRID_TYPE_POJ_INPUT)
            }
            ...
            ChoanoannSoantek.POJ_UNICODE_TO_KIP_UNICODE -> {
                koehArrayList = ChhiatKoeh.chhiatHybridInputWithRegex(str, HybridType.HYBRID_TYPE_POJ_UNICODE)
            }
            ...
            ChoanoannSoantek.KIP_INPUT_TO_POJ_INPUT -> {
                koehArrayList = ChhiatKoeh.chhiatHybridInputWithRegex(str, HybridType.HYBRID_TYPE_KIP_INPUT)
            }
            ...
            ChoanoannSoantek.KIP_UNICODE_TO_POJ_UNICODE -> {
                koehArrayList = ChhiatKoeh.chhiatHybridInputWithRegex(str, HybridType.HYBRID_TYPE_KIP_UNICODE)
            }
        }
        ...
        for (koeh in koehArrayList) {
            ...
            when (choanoannSoantek) {
                ...
                ChoanoannSoantek.POJ_INPUT_TO_POJ_UNICODE -> {
                    if (koeh.isLomajiNeedToConvertToUnicode()) {
